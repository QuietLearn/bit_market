...
*/
/**
 * 从jfreeChart中进行扩展，使得它具备滚动的动能
 *
 * @author Administrator
 *
 *//*

public class ScrollChartComposite extends Composite implements
        ChartChangeListener, ChartProgressListener, org.eclipse.swt.events.PaintListener,
        org.eclipse.swt.events.SelectionListener, MouseListener, org.eclipse.swt.events.MouseMoveListener, Printable {
    */
...
/**
    ...
    public ScrollChartComposite(Composite comp, int style) {
...
/**
    ...
    public ScrollChartComposite(Composite comp, int style, JFreeChart chart) {
...
/**
    ...
    public ScrollChartComposite(Composite comp, int style,
                                JFreeChart jfreechart, int width, int height, int minimumDrawW,
                                int minimumDrawH, int maximumDrawW, int maximumDrawH,
                                boolean usingBuffer, boolean properties, boolean save,
        ...
        drawWidth = width;//available.width;
        drawHeight = height;//available.height;
        setDisplayToolTips(tooltips);
        // create the canvas and add the required listeners
        this.canvas = new Canvas(this, org.eclipse.swt.SWT.DOUBLE_BUFFERED | org.eclipse.swt.SWT.NO_BACKGROUND| org.eclipse.swt.SWT.V_SCROLL | org.eclipse.swt.SWT.H_SCROLL);
        ...
        hBar.setMaximum(maximumDrawWidth);
        vBar.setMaximum(maximumDrawHeight);
        hBar.addListener(org.eclipse.swt.SWT.Selection, new Listener(){
            ...
            public void handleEvent(Event arg0) {
                ...
                canvas.scroll(destX,0,0,0,r.width,r.height,true);
                origin.x=-hSelection;
            }

        });
        vBar.addListener(org.eclipse.swt.SWT.Selection, new Listener(){
            ...
            public void handleEvent(Event arg0) {
                ...
                Rectangle r=canvas.getBounds();
                canvas.scroll(0,destY,0,0,r.width,r.height,true);
                origin.y=-vSelection;
            }
...
/**
    ...
    public void doSaveAs() throws IOException {
        FileDialog fileDialog = new FileDialog(this.canvas.getShell(), org.eclipse.swt.SWT.SAVE);
...
/**
    ...
    public void forceRedraw() {
        ...
        ev.count = 0;
        this.canvas.notifyListeners(org.eclipse.swt.SWT.Paint, ev);
        ev.gc.dispose();
    }
        ...
        if (pf2 != pf) {
            ...
            if (job.printDialog()) {
                try {
                    ...
                    org.eclipse.swt.widgets.MessageBox messageBox = new org.eclipse.swt.widgets.MessageBox(this.canvas
                            .getShell(), org.eclipse.swt.SWT.OK | org.eclipse.swt.SWT.ICON_ERROR);
...
/**
    ...
    protected Menu createPopupMenu(boolean properties, boolean save,
        ...
        if (properties) {
            MenuItem propertiesItem = new MenuItem(result, org.eclipse.swt.SWT.PUSH);
            propertiesItem.setText(localizationResources
        ...
        if (save) {
            if (separator) {
                new MenuItem(result, org.eclipse.swt.SWT.SEPARATOR);
                separator = false;
            }
            MenuItem saveItem = new MenuItem(result, org.eclipse.swt.SWT.NONE);
        ...
        if (print) {
            ...
            MenuItem printItem = new MenuItem(result, org.eclipse.swt.SWT.NONE);
        ...
        if (zoom) {
            ...
            MenuItem zoomInMenuItem = new MenuItem(result, org.eclipse.swt.SWT.CASCADE);
            zoomInMenuItem.setText(localizationResources.getString("Zoom_In"));
            zoomInMenuItem.setMenu(zoomInMenu);

            this.zoomInBothMenuItem = new MenuItem(zoomInMenu, org.eclipse.swt.SWT.PUSH);
            ...
            new MenuItem(zoomInMenu, org.eclipse.swt.SWT.SEPARATOR);

            this.zoomInDomainMenuItem = new MenuItem(zoomInMenu, org.eclipse.swt.SWT.PUSH);
            ...
            this.zoomInRangeMenuItem = new MenuItem(zoomInMenu, org.eclipse.swt.SWT.PUSH);
            ...
            MenuItem zoomOutMenuItem = new MenuItem(result, org.eclipse.swt.SWT.CASCADE);
            zoomOutMenuItem
                    .setText(localizationResources.getString("Zoom_Out"));
            zoomOutMenuItem.setMenu(zoomOutMenu);

            this.zoomOutBothMenuItem = new MenuItem(zoomOutMenu, org.eclipse.swt.SWT.PUSH);
            ...
            new MenuItem(zoomOutMenu, org.eclipse.swt.SWT.SEPARATOR);

            this.zoomOutDomainMenuItem = new MenuItem(zoomOutMenu, org.eclipse.swt.SWT.PUSH);
            ...
            this.zoomOutRangeMenuItem = new MenuItem(zoomOutMenu, org.eclipse.swt.SWT.PUSH);
            ...
            MenuItem autoRangeMenuItem = new MenuItem(result, org.eclipse.swt.SWT.CASCADE);
            autoRangeMenuItem.setText(localizationResources
                    .getString("Auto_Range"));
            autoRangeMenuItem.setMenu(autoRangeMenu);

            this.zoomResetBothMenuItem = new MenuItem(autoRangeMenu, org.eclipse.swt.SWT.PUSH);
            ...
            new MenuItem(autoRangeMenu, org.eclipse.swt.SWT.SEPARATOR);

            this.zoomResetDomainMenuItem = new MenuItem(autoRangeMenu, org.eclipse.swt.SWT.PUSH);
            ...
            this.zoomResetRangeMenuItem = new MenuItem(autoRangeMenu, org.eclipse.swt.SWT.PUSH);
...
/**
    ...
    public void addSWTListener(EventListener listener) {
        if (listener instanceof org.eclipse.swt.events.ControlListener) {
            this.canvas.addControlListener((org.eclipse.swt.events.ControlListener) listener);
        ...
        } else if (listener instanceof org.eclipse.swt.events.HelpListener) {
            this.canvas.addHelpListener((org.eclipse.swt.events.HelpListener) listener);
        ...
        } else if (listener instanceof org.eclipse.swt.events.MouseMoveListener) {
            this.canvas.addMouseMoveListener((org.eclipse.swt.events.MouseMoveListener) listener);
        } else if (listener instanceof org.eclipse.swt.events.MouseTrackListener) {
            this.canvas.addMouseTrackListener((org.eclipse.swt.events.MouseTrackListener) listener);
            // } else if (listener instanceof MouseWheelListener) {
            // this.canvas.addMouseWheelListener((MouseWheelListener) listener);
        } else if (listener instanceof org.eclipse.swt.events.PaintListener) {
            this.canvas.addPaintListener((org.eclipse.swt.events.PaintListener) listener);
    ...
    public void mouseMove(MouseEvent event) {
        ...
        if (this.zoomPoint != null) {
            Rectangle scaledDataArea = getScreenDataArea(this.zoomPoint.x,
                    this.zoomPoint.y);
            org.eclipse.swt.graphics.Point movingPoint = getPointInRectangle(
            ...
            if (hZoom && vZoom) {
                ...
                this.zoomRectangle = new Rectangle(scaledDataArea.x,
                        this.zoomPoint.y, scaledDataArea.width, ymax
                        - this.zoomPoint.y);
            }
            this.canvas.redraw();
        }
...
/**
    ...
    public void paintControl(PaintEvent e) {
        ...
        boolean scale = false;
        //drawWidth = 800;//available.width;
        //drawHeight = 600;//available.height;
        ...
        if (this.useBuffer) {
            ...
            if (this.chartBuffer == null|| this.chartBufferWidth != drawWidth
                    || this.chartBufferHeight != drawHeight) {
                //|| this.chartBufferWidth != available.width
                //|| this.chartBufferHeight != available.height) {
                this.chartBufferWidth =drawWidth; //available.width;
                this.chartBufferHeight =drawHeight;// available.height;
            ...
            if (this.refreshBuffer) {
                ...
                if (this.chart.getAntiAlias()) {
                    gci.setAntialias(org.eclipse.swt.SWT.ON);
                }
                if (this.chart.getTextAntiAlias() == RenderingHints.KEY_TEXT_ANTIALIASING) {
                    gci.setTextAntialias(org.eclipse.swt.SWT.ON);
                }
            ...
            sg2.drawImage(this.chartBuffer, origin.x, origin.y);
        }
        // or redrawing the chart every time...
            ...
            if (this.chart.getTextAntiAlias() == RenderingHints.KEY_TEXT_ANTIALIASING) {
                e.gc.setTextAntialias(org.eclipse.swt.SWT.ON);
            }
            this.chart.draw(sg2, new Rectangle2D.Double(origin.x, origin.y,
        ...
        if (this.verticalAxisTrace && area.y < this.horizontalTraceLineY
            ...
            e.gc.drawLine(area.x, this.horizontalTraceLineY, area.x
                    + area.width, this.horizontalTraceLineY);
        }
