...
public class average {
    ...
    public static void main(String[] args) {
        ...
        // 创建菜单
        /* 1 */
        JMenu mnuSystem = new JMenu("系统(S)");
        /* 2 */
        JMenu mnuSystem1 = new JMenu("工具(T)");
        // 创建菜单项
    ...
    public static JFreeChart buildChart() {
        ...
        //domainAxis.setTimeline(SegmentedTimeline.newMondayThroughFridayTimeline());// SegmentedTimeline为分割时间线的意思
    ...
    protected static OHLCDataset getPriceDataSet(String symbol) {
        ...
        try {
            ...
            //.openStream()));
            BufferedReader in = new BufferedReader(new FileReader("C:\\Users\\Administrator\\Desktop\\bitmarket2.xml"));
