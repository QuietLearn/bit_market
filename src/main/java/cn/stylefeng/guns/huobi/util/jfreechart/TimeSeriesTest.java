...
public class TimeSeriesTest extends ApplicationFrame implements ChartMouseListener, MouseListener, MouseMotionListener {
    ...
    private static XYDataset createDataset() {
        ...
        TimeSeries localTimeSeries1 = new TimeSeries("随机数据");
        ...
        //, Hour.class
        TimeSeries localTimeSeries2 = new TimeSeries("随机数据");
    ...
    private static JFreeChart createChart(XYDataset xyDataset) {
        ...
        xAxis.setTickUnit(new DateTickUnit(DateTickUnitType.HOUR, 2, fmt));
// Y轴
